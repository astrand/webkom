...
#
# Patched by Peter Åstrand <astrand@lysator.liu.se> to use FIFOs
#
...
class InteractiveInterpreter:
    ...
    def __init__(self, outobj, inobj, locals=None):
        """Constructor.
    ...
    def runcode(self, code):
        ...
        """
        try:
            sys.stdout = self.outobj
            sys.stderr = self.outobj
            sys.stdin = self.inobj
...
class InteractiveConsole(InteractiveInterpreter):
    ...
    def __init__(self, outobj, inobj, locals=None, filename="<console>"):
        """Constructor.
        ...
        """
        InteractiveInterpreter.__init__(self, outobj, inobj, locals)
...
def interact(banner=None, readfunc=None, local=None, fifoprefix="unnamed"):
    ...
    console = InteractiveConsole(outobj, inobj, local)
